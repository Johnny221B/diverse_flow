...
CUDA_VISIBLE_DEVICES=$GPUS python scripts/ourmethod_t2i.py --spec specs/t2i_small_set.json --method ourmethod --G $G_VAL --guidance $CFG_VAL  --steps $STEPS
...
CUDA_VISIBLE_DEVICES=$GPUS python scripts/baseline_dpp_t2i.py --spec specs/t2i_small_set.json --method dpp --G $G_VAL --guidance $CFG_VAL --openai_clip_jit_path "$CLIP_PATH" --steps $STEPS
...
CUDA_VISIBLE_DEVICES=$GPUS python scripts/baseline_cads_t2i.py --spec specs/t2i_small_set.json --method cads --G $G_VAL --guidance $CFG_VAL  --steps $STEPS --category small
